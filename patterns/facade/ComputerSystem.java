...
class CPU {
    public void powerOn(){
        System.out.println("CPU: Turning ON");
    }
}
...
public class ComputerSystem{
    public static void main(String[] args) {
        ComputerSystemFacade computerSystemFacade = new ComputerSystemFacade();
        computerSystemFacade.startComputer();
    }
}